...
// function getTM2(satellite, level, parameter, timestamp) {
//   return new Promise(function (resolve, reject) {
//     const hostLS = localStorage.getItem("host");
//     const portLS = localStorage.getItem("port");
//     const query = GetTMQuery(hostLS, portLS, satellite, level, parameter, timestamp);
...
//         const dataElement = tempElement.querySelector("bin");
